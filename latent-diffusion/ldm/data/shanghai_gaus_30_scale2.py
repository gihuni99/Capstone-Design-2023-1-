...
class ShanghaiTrain(ShanghaiBase):
    def __init__(self, **kwargs):
        super().__init__(data_dir="../train/train_data/train_density_gaus_30_scale2",**kwargs)


class ShanghaiValidation(ShanghaiBase):
    def __init__(self, **kwargs):
        super().__init__(data_dir="../valid/valid_data/valid_density_gaus_30_scale2",**kwargs)

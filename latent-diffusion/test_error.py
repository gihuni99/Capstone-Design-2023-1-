...
## 2023-06-07T03-02-27_shanghai_amh << 기록
    ...
    config_path = 'logs/2023-06-13T12-18-30_spatial_concat_A_valid/configs/2023-06-13T12-18-30-project.yaml' # origin: crossattn, 3: concate
    ckpt_path = 'logs/' + '2023-06-09T19-21-30_spatial_concat_error' + '/checkpoints/last.ckpt' # concate

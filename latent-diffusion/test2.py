...
## 2023-06-07T03-02-27_shanghai_amh << 기록
    ...
    config_path = 'logs/2023-06-10T14-54-08_spatial_concat/configs/2023-06-10T14-54-08-project.yaml' # origin: crossattn, 3: concate
    ckpt_path = 'logs/' + '2023-06-10T14-54-08_spatial_concat' + '/checkpoints/last.ckpt' # concate
